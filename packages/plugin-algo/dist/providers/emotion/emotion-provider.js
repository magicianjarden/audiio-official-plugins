...
exports.EmotionProvider = void 0;
...
class EmotionProvider {
     ...
     */
    async getEmotionFeatures(trackId) {
        // Check cache
    ...
    async analyzeAudio(audioData, sampleRate) {
        ...
        try {
            ...
            const moodCategory = (0, ml_sdk_1.valenceArousalToMood)(valence, arousal);
            return {
                valence,
                arousal,
                moodCategory,
     ...
     */
    async computeMelSpectrogram(audioData) {
...
//# sourceMappingURL=emotion-provider.js.map