...
exports.MusicBrainzMetadataProvider = void 0;
...
class MusicBrainzMetadataProvider extends sdk_1.BaseMetadataProvider {
    id = 'musicbrainz';
    name = 'MusicBrainz';
    priority = 60; // Lower than Deezer (80) - acts as fallback
    ...
    async search(query, options) {
        ...
        try {
            ...
            const tracks = await Promise.all(recordings.slice(0, limit).map(recording => this.mapRecording(recording)));
            return {
                tracks,
                artists: [],
                albums: []
    ...
    async getArtist(id) {
        ...
        try {
            ...
            const releaseGroupsData = releaseGroupsResponse.ok
                ? await releaseGroupsResponse.json()
                : { 'release-groups': [] };
...
exports.MusicBrainzMetadataProvider = MusicBrainzMetadataProvider;
// Default export for addon loading
exports.default = MusicBrainzMetadataProvider;
