...
exports.AudioFeaturesDatabase = void 0;
exports.getAudioFeaturesDatabase = getAudioFeaturesDatabase;
...
class AudioFeaturesDatabase {
    ...
    findSimilar(features, limit = 20) {
      ...
      LIMIT ?
    `).all(features.danceability, features.energy, features.valence, features.acousticness, features.instrumentalness, features.tempo / 200.0, features.spotifyId, limit);
...
exports.AudioFeaturesDatabase = AudioFeaturesDatabase;
// Singleton
let instance = null;
function getAudioFeaturesDatabase() {
    if (!instance) {
        instance = new AudioFeaturesDatabase();
    }
    return instance;
}
//# sourceMappingURL=audio-features-db.js.map